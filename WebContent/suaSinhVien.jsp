...
<div class="container">
    ...
    <br>
	<html:form action="/suaSV" acceptCharset="UTF-8" method="post" enctype="multipart/form-data">
        ...
        <div class="row form-group">
        	...
        	<div class="col-lg-3">
            	<img src = "<bean:write name="sinhVienForm" property="hinhDaiDien"/>" alt = "avatar" style = "height: 50px; weight: 50px"/>
            </div>
        </div>
        <div class="row form-group">
        	<label class="col-lg-2">Đổi Hình Ảnh</label>
        	<div class="col-lg-3">
            	<html:file styleClass="form-control" styleId="hinhDaiDien" style = "height: 30px; padding-top: 5px; padding-bottom: 30px" property="file"/>
            </div>
        </div>
        <div class="row form-group">
